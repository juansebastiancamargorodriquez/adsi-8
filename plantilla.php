...
<body class="hold-transition skin-blue sidebar-collapse sidebar-mini login-page">
  ...
  <?php
    ...
    if(isset($_GET["ruta"])){
      ...
      if($_GET["ruta"] == "inicio" ||
         $_GET["ruta"] == "usuarios" ||
         $_GET["ruta"] == "disponibilidad" ||
         $_GET["ruta"] == "interopelabilidad" ||
         $_GET["ruta"] == "modificabilidad" ||
         $_GET["ruta"] == "control" ||
          $_GET["ruta"] == "rendimiento" ||
          $_GET["ruta"] == "testabilidad" ||
           $_GET["ruta"] == "contactame" ||
         $_GET["ruta"] == "seguridad"){
...
<script src="vistas/js/control.js?v=<?=md5_file('vistas/js/control.js')?>"></script>
